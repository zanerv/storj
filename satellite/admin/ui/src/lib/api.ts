    ...
    bucket: [
      {
        ...
        func: async (projectId: string, bucketName: string): Promise<object> => {
      ...
      },
      {
        ...
        func: async (projectId: string, bucketName: string, region: string): Promise<object> => {
    ...
    user: [
      {
        ...
        func: async (email: string, fullName: string, password: string): Promise<object> => {
